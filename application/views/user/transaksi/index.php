  ...
  <div class="row">
    <div class="col-md-12">
      <ul class="breadcrumb">
        ...
        <li><i class="glyphicon glyphicon-plus"></i> <a href="<?php echo base_url('user/transaksi/add/0'); ?>">Tambah Transaksi</a></li>
      </ul>
    </div>
  </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="operations-td">
              ...
              <a href="<?php echo base_url('user/transaksi/add/0'); ?>" rel="tooltip" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
